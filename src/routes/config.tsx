    ...
    return (
      <div>
        ...
        <EmptyState
          ...
          description="Seed data to create sample conferences."
        />
      </div>
    );
  }
    ...
    <div>
      ...
      <div className="not-prose space-y-8">
        {conferences.map((conference) => (
          <ConferenceConfig key={conference._id} conference={conference} />
        ))}
      </div>
    </div>
  );
...
function ConferenceConfig({ conference }: { conference: Doc<"conferences"> }) {
